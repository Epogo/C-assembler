/*
1.צריך לדאוג לשחרר זכרון עבור הקצאות נתונים
2.צריך לדעת מתי להדפיס פקודות ומתי להדפיס נתונים (צריך להוסיף קוד שידע לעשות את זה)
3.צריך להתחיל לעשות סימולציה של מעבר שני וגם להתחיל לשמור תוויות (לסמלץ טבלת סמלים).
4.להוסיף גם ספירת פקודות וספירת נתונים
*/
