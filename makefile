...
readFile.o: readFile.c assembler.h
	gcc -c -g -Wall -ansi -pedantic readFile.c -o readFile.o
handleInput.o: handleInput.c assembler.h
	gcc -c -g -Wall -ansi -pedantic handleInput.c -o handleInput.o
manageContents.o: manageContents.c assembler.h
	gcc -c -g -Wall -ansi -pedantic manageContents.c -o manageContents.o
...
checkCommands.o: checkCommands.c assembler.h
	gcc -c -g -Wall -ansi -pedantic checkCommands.c -o checkCommands.o
checkDirectives.o: checkDirectives.c assembler.h
	gcc -c -g -Wall -ansi -pedantic checkDirectives.c -o checkDirectives.o
assToBin.o: assToBin.c assembler.h
	gcc -c -g -Wall -ansi -pedantic assToBin.c -o assToBin.o -lm
