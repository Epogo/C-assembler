main: secondPass.o symbolTable.o firstPass.o manageContents.o handleInput.o readFile.o main.o
	gcc -Wall -ansi -pedantic main.o readFile.o handleInput.o manageContents.o firstPass.o symbolTable.o secondPass.o -o main
